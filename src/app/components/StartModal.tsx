      ...
      {showModal &&
        <div className="bg-background dark:bg-background-dark bg-opacity-80 fixed inset-0 z-50 flex justify-center">
          <div className="mx-5 flex flex-col justify-center fixed gap-8 top-20 bg-white dark:bg-black py-7 px-7 rounded-xl shadow-2xl shadow-gray-800">
            ...
            <footer className="flex flex-col justify-center items-center gap-2 text-lg text-gray-800 dark:text-gray-200 mb-8">
              <h4>Are you ready to play?</h4>
              <button onClick={handleStartClick} className=" rounded-full px-8 py-2 text-white bg-green-700 hover:bg-green-600 active:bg-green-800 transition">Start</button>
              <div>
